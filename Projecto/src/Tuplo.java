public class Tuplo {
	...
	public Tuplo(int id, String packages,String classs, String metodo, int loc, int cylo, int atfd, double laa, boolean is_long_method, boolean plasma, boolean pmd, boolean is_feature_envy) {
		this.id=id;
